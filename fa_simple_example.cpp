...
const ll m = 20;			// number of sparks with normal explosion
const ll mh = 20;			// number of sparks with Gaussian explosion
...
dbl f(vd &v) { return 3 * pow(v[0] + 2, 2) + pow(v[1] - 1, 2); }
...
// Compile
// g++ -lm -O2 -std=c++11 fa_simple_example.cpp

// Execution
// ./a.out > simple_out.txt